...
?><div class="bDiv" >
		...
		<thead>
			<tr class='hDiv'>
				...
				<th align="left" abbr="tools" axis="col1">
                            ...
                            <div class='tools'>				
                                    <?php if(!$unset_delete){?>
                                        <a href='<?php echo $row->delete_url?>' title='<?php echo $this->l('list_delete')?> <?php echo $subject?>'>
                                            <img src="<?=site_url('image/png/glyphicons_207_remove_2.png');?>" alt="Удалить" />
                                        </a>
                                    <?php }?>
                                        <?php if(!$unset_edit){?>
                                            <a href='<?php echo $row->edit_url?>' title='<?php echo $this->l('list_edit')?> <?php echo $subject?>'>
                                                <img src="<?=site_url('image/png/glyphicons_030_pencil.png');?>" alt="Изменить" />
                                            </a>
                                        <?php }?>
                                    <?php 
