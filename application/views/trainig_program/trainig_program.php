        ...
        <div id="main">
            <div id="main-inner">
                ...
                <div id="brief-info" class="content-page">
                    <p>Программа тренировок является важнейшей частью улучшения фигуры.
                       Именно от ее правильности зависит эффективность занятий.
                       Хочешь добиться отличных результатов и не потерять время впустую?
                       Тогда доверь составление программы тренировок настоящему профессионалу!
                       Многократная чемпионка в сфере фитнеса и сертифицированный опытный тренер напишет для тебя индивидуальную программу тренировок, благодаря которой ты добьешься прекрасного результата.</p>
                </div>
                <div id="select-form">
...
<!--                                        <input type="button" name="submit" id="submit" value=""/>-->
                                ...
                                <p>Стоимость индивидуальной программы тренировок составляет 950 рублей. После совершения заказа, данные поступят тренеру и в течении 4 дней будет составлена твоя программа. После этого мы вышлем ее тебе на указанную почту в файле формата Excel и подробные инструкции-комментарии по ее особенностям.
                                    Помимо программы тренировок мы вышлем тебе примерный вариант диеты, которая поможет в достижении твоей цели.</p>
                                </div>
                            </div>
                        </div>
                    </div>
