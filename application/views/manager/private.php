            ...
            <div id="main-inner" class="base-info-manager">
                ...
                <div class="left-block">
                    <div class="info-block">
                        <h2 class="sidebar-option-title">Логотип</h2>
                            ...
                            <input id="logo-save" class="blue-small-button" type="button" value="Сохранить" clubId = "<?=$club->id;?>" />
                        </div>
                    </div>
                    <div class="info-block">
                        <h2 class="sidebar-option-title">Услуги</h2>
                        <div class="save-form box sidebar-items">
                            ...
                            <?endforeach; ?>
                             ...
                             <input id="service-save" style="margin-left: 10px;" class="blue-small-button" type="button" value="Сохранить" />
                        </div>
                    </div>
                </div>
                ...
                <div class="right-block">
                    <div class="info-block">
                        <h2 class="sidebar-option-title">Общая информация</h2>
                        <div class="save-form box">
                            <table class="user-input">
                                <tr>
                                    <td><label class="caption">Наименование</label></td>
                                    <td><input class="large" name="name" type="text" placeholder="Наименование" value="<?=$club->name;?>" validator="blank"/></td>
                                </tr>
                                <tr>
                                    <td><label class="caption">Сайт</label></td>
                                    <td><input class="large" name="site" type="text" placeholder="Сайт" value="<?=$club->site;?> " validator="empty"/></td>
                                </tr>
                                <tr>
                                    <td><label class="caption">Телефон</label></td>
                                    <td><input class="large" name="phone" type="text" placeholder="Телефон" value="<?=$club->phone;?>" validator="empty"/></td>
                                </tr>
                                <tr>
                                    <td><label class="caption">Режим работы</label></td>
                                    <td><input class="large" name="work_hours" type="text" placeholder="Режим работы" value="<?=$club->work_hours;?>" validator="empty"/></td>
                                </tr>
                                <tr>
                                    <td><label class="caption">Город</label></td>
                                    <td>
                                        <select class="large" name="cityid" id="city-combobox">
                                ...
                                <tr>
                                    ...
                                    <td><select class="large" name="districtId" id="district-combobox">
                                ...
                                <tr>
                                    ...
                                    <td><input class="large" name="address" type="text" placeholder="Адрес" value="<?=$club->address;?>" validator="empty"/></td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <input id="common-save" class="blue-small-button" type="button" value="Сохранить" />
                                    </td>
                                </tr>
                            </table>
                        </div>
                    ...
                    <div class="info-block">
                        <h2 class="sidebar-option-title">Описание</h2>
                        <div class="box save-form">
                            <table class="user-input">
                                <tr>
                                    <td> <textarea name="descript" placeholder="Описание..." validator="empty"><?=$club->description;?></textarea> </td>
                                </tr>
                                <tr>
                                    <td colspan="2"><input id="descript-save" class="blue-small-button" type="button" value="Сохранить" /></td>
                                </tr>
                            </table>
                        </div>
                    </div>
                    ...
                    <div class="info-block">
                        <h2 class="sidebar-option-title">Стоимость посещений</h2>
                        <div class="box save-form">
                        <table class="user-input">
                            <tr>
                                <td> <label class="caption">Разовое посещение</label> </td>
                                <td> <input class="large" name="singlePrice" type="text" placeholder="Разовое посещение" value="<?=$club->singlePrice;?>" validator="number"/> </td>
                            </tr>
                            <tr>
                                <td> <label class="caption">1 месяц</label> </td>
                                <td> <input class="large" name="sub1" type="text" placeholder="1 месяц" value="<?=$club->sub1;?>" validator="number"/> </td>
                            </tr>
                            <tr>
                                <td> <label class="caption">3 месяца</label> </td>
                                <td> <input class="large" name="sub3" type="text" placeholder="3 месяца" value="<?=$club->sub3;?>" validator="number"/> </td>
                            </tr>
                            <tr>
                                <td> <label class="caption">6 месяцев</label> </td>
                                <td> <input class="large" name="sub6" type="text" placeholder="6 месяцев" value="<?=$club->sub6;?>" validator="number"/> </td>
                            </tr>
                            <tr>
                                <td> <label class="caption">1 год</label> </td>
                                <td> <input class="large" name="sub12" type="text" placeholder="1 год" value="<?=$club->sub12;?>" validator="number"/> </td>
                            </tr>
                            <tr>
                                <td colspan="2"><input id="prices-save" class="blue-small-button" type="button" value="Сохранить" /></td>
                            </tr>
                        </table>
                        </div>
                    </div>
